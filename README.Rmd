...
The goal of **spEcula** is to make it easier to use R for **spatial prediction** based on **various spatial relationships** (e.g. spatial dependence, spatial heterogeneity, geographical similarity).
