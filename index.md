...
|-----------------------------------|-------------------------------------------------------------------------|--------------------|
| Geographically Optimal Similarity | [`gos()`](https://spatlyu.github.io/spEcula/reference/gos.md)           | ✔️                 |
| Sandwich Mapping Model            | [`sandwich()`](https://spatlyu.github.io/spEcula/reference/sandwich.md) | ✔️                 |
...
![](reference/figures/README-gos_result-1.png)
...
![](reference/figures/README-sandwich-1.png)
...
![](reference/figures/README-sandwich_sim_est-1.png)
