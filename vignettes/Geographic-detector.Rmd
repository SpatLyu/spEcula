...
##  GeoDetector model <img src="../man/figures/logo.png" align="right" height="75"/>

This vignette explains how to run a `geodetector` model in `spEcula` package.

<div class="figure" style="text-align: center">
<img src="../man/figures/gd_flowchart.png" alt="Schematic overview of Geographic detectors(geodetector) model" width="75%" />
<p class="caption">Schematic overview of Geographic detectors(geodetector) model</p>
</div>
